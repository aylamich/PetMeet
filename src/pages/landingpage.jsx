...
function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen bg-red-50">
      ...
      <nav className="bg-white shadow fixed w-full z-10">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="space-x-6 hidden md:flex">
            ...
            <a href="#beneficios" className="text-gray-700 hover:text-red-400">Benefícios</a>
            <a href="#depoimentos" className="text-gray-700 hover:text-red-400">Depoimentos</a>
            <a href="#comeceagora" className="text-gray-700 hover:text-red-400">Comece Agora</a>
          </div>
          <a
            href="/login"
      ...
      {/* Benefícios */}
      <section id="beneficios" className="py-16 bg-white scroll-mt-24">
      ...
      {/* Depoimentos */}
      <section id="depoimentos" className="py-16 bg-red-100 scroll-mt-24">
        <div className="max-w-7xl mx-auto px-6 text-center">
      ...
      {/* Comece Agora */}
      <section id="comeceagora" className="py-16 bg-blue-900 text-white text-center scroll-mt-24">
